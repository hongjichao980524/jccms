...
<head>
    ...
    <title>{{$basic['site_title']}}-登录</title>
...
<body style="background:#836FFF;">
    
    <div class="content">
    <form class="layui-form" action="">
        @csrf
        <input type="hidden" id="refer" value="{{$refer}}">
        <div class="wrap"><h2>{{$basic['site_title']}}</h2></div>
            ...
            <label class="layui-form-label">验证码</label>
                ...
                <div class="layui-inline">
                    <img src="/account/captcha" id="captcha" style="border: 1px solid #cdcdcd;cursor:pointer;" onclick="reload_captcha()">
                </div>
            </div>
            <div class="layui-form-item">
    ...
    <script>
        ...
        function dologin(){
            ...
            $.post('/account/dologin',{_token:token,'username':username,'password':password,'verifycode':verifycode},
            function(res){
                if(res.code>0){
